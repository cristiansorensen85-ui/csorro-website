# Build 060 — Website + OS Foundation Redesign
...
## Notes
The OS still contains older module pages from previous builds. This build starts aligning the dashboard and public website first. Next pass should redesign module pages one-by-one so the OS no longer feels mismatched.
